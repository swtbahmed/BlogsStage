    ...
    <div class="row">
        <div class="col-x1-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{url('/user/createblog')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-x1-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" name="image_alt" id="image_alt" placeholder="my blog image" value="{{old('image_alt')}}"  class="form-control">
                        ...
                        <div class="form-row">
                            <div class="form-group col-x1-12 col-lg-12 col-md-12 col-sm-12">
                                ...
                                <input type="text" name="text" id="text" placeholder="For Ex : How to use Blog" value="{{old('text')}}" class="form-control">
                            ...
                            <div class="form-group col-x1-12 col-lg-12 col-md-12 col-sm-12">
                                ...
                                <textarea class="form-control" name="short_description" id="shortdescription" rows="5" >{{old('short_description')}}</textarea>
